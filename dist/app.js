...
var app = new Vue({
	...
	methods: {
		swiperJs: function swiperJs(that, lock) {
		...
		getCircleXY: function getCircleXY(event) {
			var C_OBJ = {},
			    BASE_WIDTH = 414,
			    BASE_HEIGHT = 736,
		...
		showProject: function showProject(event) {
			...
			if (PARENT_ELM.getAttribute('class') === 'project-item') {
				...
				this.projectItem.info = _data.lpj['Projects'][ITEM];
		...
		hideProject: function hideProject(event) {
			var _this3 = this;
			...
			setTimeout(function () {
				// filter: blur(8px)
				_this3.showInfoNum = _this3.showInfoNum + 1;
				console.log(_this3.projectItem.showInfo + ' ,' + _this3.showInfoNum);
				_this3.projectItem.info = false;
			}, 400);
		}
	},
	computed: {
		getProjectItemInfo: function getProjectItemInfo() {
			return this.projectItem.info;
		}
	},
	watch: {
		getProjectItemInfo: function getProjectItemInfo(info) {
			var _this4 = this;

			if (!!info) {
				setTimeout(function () {
					_this4.projectItem.left = 0;
					_this4.projectItem.top = 0;
					_this4.projectItem.width = '100%';
					_this4.projectItem.height = '100%';
				}, 100);
			}
		}
	}
