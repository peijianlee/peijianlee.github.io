...
var lpj = exports.lpj = {
	...
	"Skills": [{
		...
		"skill": "CSS/CSS3",
		"des": "比较熟练使用 CSS 进行对网页的排版，能使用 css3 animation 属性对标签添加简单的动画。对 Sass、Less、Stylus 的CSS预编译也有一定的理解。"
	}, {
		"icon": {
	...
	"About": {
		"title": "自我简介",
		"des": "本人主攻前端开发方向和 Node.js 开发，目标是成为独当一面的全栈开发程序员。有近5年的开发经验<span>（期间断断续续，因为在工作过程中也运营过公众号、自媒体，也对其有一点点的理解和经验）</span>，一直都是待过技术团队都是以小团队居多，使自己的技术得不到更高突破和提升。做过企业官网、商城网站及由前端到后台全部由个人编写的小程序。",
