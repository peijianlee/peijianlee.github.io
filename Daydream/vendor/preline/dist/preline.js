    ...
    var e = {
          ...
          var d = (function (e) {
            ...
            function d() {
              ...
              return (
                ...
                ((e = a.call(this, '.hs-dropdown')).positions = {
                  top: 'top',
                  'top-left': 'top-start',
                  'top-right': 'top-end',
                  bottom: 'bottom',
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    i > 1 ||
                      ...
                      n.setAttribute('data-hs-overlay-backdrop-template', ''),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    this._fireEvent('scroll', t),
                      ...
                      l.scrollTo({ top: a, left: 0, behavior: 'smooth' });
                  },
                },
              ]) && r(t.prototype, o),
              Object.defineProperty(t, 'prototype', { writable: !1 }),
          ...
          var a = (function (e) {
            ...
            function u() {
              return (
                ...
                l.call(this, '[data-hs-smooth-scroll-to]')
              );
            }
            return (
              (t = u),
                  ...
                  value: function (e) {
                    if (this.getClassProperty(e, '--target')) {
                      var t = e.querySelector(
                        this.getClassProperty(e, '--target')
                      );
                      if (t) {
                        var o =
                            this.getClassProperty(e, '--scroll-offset') || 0,
                          n = t.getBoundingClientRect().top - o;
                        e.scrollTo({ behavior: 'smooth', top: n });
                      }
                    }
                  },
                },
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    o.forEach(function (e) {
                      ...
                      s && (s.value = e.getAttribute('data-hs-tab'));
                  },
                },
                {
                  key: '_keyboardSupport',
        ...
        714: (e, t, o) => {
          ...
          function z(e) {
            ...
            switch (i) {
              case E:
                t = { x: c, y: o.y - n.height };
                break;
              case x:
                t = { x: c, y: o.y + o.height };
                break;
              case j:
                t = { x: o.x + o.width, y: a };
                break;
            ...
            if (f) {
              ...
              C === n(o) &&
                ...
                (i === E || ((i === P || i === j) && s === q)) &&
                  ((L = x),
                  (g -=
                    (y && A.visualViewport ? A.visualViewport.height : C[T]) -
                    r.height),
                  (g *= u ? 1 : -1)),
                (i !== P && ((i !== E && i !== x) || s !== q)) ||
                  ((_ = j),
                  (m -=
                    (y && A.visualViewport ? A.visualViewport.width : C[R]) -
                    r.width),
                  (m *= u ? 1 : -1));
            }
            var D,
              H = Object.assign({ position: a }, f && F),
              B =
                !0 === p
                  ? (function (e) {
                      var t = e.x,
            ...
            return t === T
              ...
              : ee(
                  (function (e) {
                    ...
                    return (
                      'rtl' === h(r || o).direction &&
                        (a += c(o.clientWidth, r ? r.clientWidth : 0) - i),
            ...
            defaultModifiers: [
              {
                ...
                effect: function (e) {
                  ...
                  return (
                    ...
                    a && l.addEventListener('resize', o.update, $),
                    function () {
                      s &&
                        u.forEach(function (e) {
                  ...
                  if (A) {
                    if (i) {
                      var I,
                        ...
                        oe = ie(0, q[W], K[W]),
                        ne = O
                          ? q[W] / 2 - X - oe - ee - D.mainAxis
                          : Y - oe - ee - D.mainAxis,
                        se = O
                          ? -q[W] / 2 + X + oe + te + D.mainAxis
                          : G + oe + te + D.mainAxis,
              ...
              },
              {
                ...
                fn: function (e) {
                  var t = e.state,
                    ...
                    s = re(t, { elementContext: 'reference' }),
                    c = re(t, { altBoundary: !0 }),
                    a = se(s, n),
                    l = se(c, r, i),
                    u = ce(a),
                    f = ce(l);
        ...
        var f = (function (e) {
          ...
          function p() {
            ...
            return (
              ...
              ((e = f.call(this, '.hs-mega-menu'))._history = t.Z),
              e
            );
          }
          return (
            ...
            (n = [
                ...
                value: function () {
                  ...
                  document.addEventListener('click', function (t) {
                    ...
                    var s = n.getAttribute('data-hs-mega-menu-trigger'),
                      c =
                        'flex' ===
                        window.getComputedStyle(n.closest('nav')).display;
                    if (
                      ((n &&
                        (n.classList.contains('open') ||
                          n.parentElement.closest(e.selector))) ||
                      ...
                      if (
                        'false' ==
                        n.getAttribute('data-hs-mega-menu-auto-close')
                      )
                        return;
                      if (n.parentElement.closest(e.selector))
                        return e._closeAll();
                      if ('hover' === s && n.classList.contains('open'))
                        return e.close(n);
                    }
                    ('hover' === s && c) ||
                      (n.classList.contains('open') ? e.close(n) : e.open(n));
                        ...
                        t.addEventListener('mouseenter', function (o) {
                          'hover' ===
                            window
                              ...
                              .replace(' ', '') &&
                            (t.querySelector('.hs-mega-menu-content'),
                            t && e._hover(t));
                        });
                      }),
                    document.addEventListener(
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  document
                    .querySelectorAll(''.concat(this.selector, '.open'))
                    .forEach(function (t) {
                      'false' !=
                        t.getAttribute('data-hs-mega-menu-auto-close') &&
                        e.close(t);
                    });
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this;
                  'flex' ===
                    window.getComputedStyle(e.closest('nav')).display &&
                    (this.open(e),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  e.classList.remove('open'),
                    ...
                    this._fireEvent('close', e),
                    this._dispatch('close.hs.megaMenu', e, e);
                },
              },
              {
                key: 'open',
                value: function (e) {
                  ...
                  window.getComputedStyle(t),
                    parseInt(o.left) + parseInt(o.width) > window.innerWidth &&
                      ((t.style.right = '100%'), (t.style.left = 'unset')),
                    setTimeout(function () {
                      e.classList.add('open');
                    }, 10),
                    this._fireEvent('open', e),
                    this._dispatch('open.hs.megaMenu', e, e);
                },
              },
              {
                key: 'toggle',
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (t.length) {
                    var o = t[t.length - 1];
                    return 27 === e.keyCode
                      ? (e.preventDefault(), this._esc(o))
                      : 40 === e.keyCode
                      ? (e.preventDefault(), this._down(o))
                      : 38 === e.keyCode
                      ? (e.preventDefault(), this._up(o))
                      : 36 === e.keyCode
                      ? (e.preventDefault(), this._start(o))
                      : 35 === e.keyCode
                      ? (e.preventDefault(), this._end(o))
                      : void this._byChar(o, e.key);
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  var t = e.querySelector('.hs-mega-menu-content'),
                    o = i(t.querySelectorAll('a, button'))
                      .reverse()
                      .filter(function (e) {
                        return (
                          !e.disabled &&
                          e.closest('.hs-mega-menu-content') === t
                        );
                      }),
                    n =
                ...
                value: function (e) {
                  var t = e.querySelector('.hs-mega-menu-content'),
                    o = i(t.querySelectorAll('a, button')).filter(function (e) {
                      return (
                        !e.disabled && e.closest('.hs-mega-menu-content') === t
                      );
                    }),
                    n =
                      t.querySelector('a:focus') ||
              ...
              },
              {
                ...
                value: function (e, t) {
                  var o = this,
                    n = i(
                      e
                        .querySelector('.hs-mega-menu-content')
                    ...
                    s = r();
                  -1 === s && (this._history.clearHistory(), (s = r())),
                    -1 !== s && (n[s].focus(), this._history.addHistory(s));
                },
              },
            ]) && c(o.prototype, n),
